...
export default class extends Vue {
  ...
  private filterValue(originValue: string) {
    // let newData: any = {};
    // let reg = /<h2>(\S*)<\/h2>/g;
    // let timelen: string[]| null = originValue.match(reg);
    // let time = timelen ? timelen[0].substr(5, timelen.length - 6) : '';
    // console.log(timelen ? timelen[0].split('(')[1].split(')')[0] : '', time);
  }
}
</script>
